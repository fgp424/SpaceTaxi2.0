...
/// <summary> Method that initializes game state</summary>
        public void InitializeGameState(){
            ...
            menuButtons = new[]{new Text("Resume Game",new Vec2F(0.35f, 0.3f), new Vec2F(0.4f, 0.4f)),
            new Text("Main Menu",new Vec2F(0.35f, 0.1f), new Vec2F(0.4f, 0.4f))
            };
                ...
                switch(keyValue) {
                    ...
                    case "KEY_SPACE":
                        if (activeMenuButton == 0) {
                            ...
                            GameEventType.GameStateEvent, this, "CHANGE_STATE", "GAME_RESUME", ""));
